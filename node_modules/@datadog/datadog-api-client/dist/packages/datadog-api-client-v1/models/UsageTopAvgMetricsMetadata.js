...
var UsageTopAvgMetricsMetadata = /** @class */ (function () {
    ...
    UsageTopAvgMetricsMetadata.deserialize = function (data) {
        ...
        res.day = ObjectSerializer_1.ObjectSerializer.deserialize(data.day, "Date", "date-time");
    ...
    UsageTopAvgMetricsMetadata.serialize = function (data) {
        ...
        res.day = ObjectSerializer_1.ObjectSerializer.serialize(data.day, "Date", "date-time");
