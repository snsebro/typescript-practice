...
var UsageSummaryResponse = /** @class */ (function () {
    ...
    UsageSummaryResponse.deserialize = function (data) {
        ...
        res.auditLogsLinesIndexedAggSum = ObjectSerializer_1.ObjectSerializer.deserialize(data.audit_logs_lines_indexed_agg_sum, "number", "int64");
        ...
        res.cspmContainerAvgSum = ObjectSerializer_1.ObjectSerializer.deserialize(data.cspm_container_avg_sum, "number", "int64");
        res.cspmContainerHwmSum = ObjectSerializer_1.ObjectSerializer.deserialize(data.cspm_container_hwm_sum, "number", "int64");
        res.cspmHostTop99pSum = ObjectSerializer_1.ObjectSerializer.deserialize(data.cspm_host_top99p_sum, "number", "int64");
        res.customTsSum = ObjectSerializer_1.ObjectSerializer.deserialize(data.custom_ts_sum, "number", "int64");
        res.cwsContainersAvgSum = ObjectSerializer_1.ObjectSerializer.deserialize(data.cws_containers_avg_sum, "number", "int64");
        res.cwsHostTop99pSum = ObjectSerializer_1.ObjectSerializer.deserialize(data.cws_host_top99p_sum, "number", "int64");
    ...
    UsageSummaryResponse.serialize = function (data) {
        ...
        res.audit_logs_lines_indexed_agg_sum = ObjectSerializer_1.ObjectSerializer.serialize(data.auditLogsLinesIndexedAggSum, "number", "int64");
        ...
        res.cspm_container_avg_sum = ObjectSerializer_1.ObjectSerializer.serialize(data.cspmContainerAvgSum, "number", "int64");
        res.cspm_container_hwm_sum = ObjectSerializer_1.ObjectSerializer.serialize(data.cspmContainerHwmSum, "number", "int64");
        res.cspm_host_top99p_sum = ObjectSerializer_1.ObjectSerializer.serialize(data.cspmHostTop99pSum, "number", "int64");
        res.custom_ts_sum = ObjectSerializer_1.ObjectSerializer.serialize(data.customTsSum, "number", "int64");
        res.cws_containers_avg_sum = ObjectSerializer_1.ObjectSerializer.serialize(data.cwsContainersAvgSum, "number", "int64");
        res.cws_host_top99p_sum = ObjectSerializer_1.ObjectSerializer.serialize(data.cwsHostTop99pSum, "number", "int64");
