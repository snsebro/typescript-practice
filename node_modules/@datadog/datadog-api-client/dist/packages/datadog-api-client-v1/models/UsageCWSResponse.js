...
var UsageCWSResponse = /** @class */ (function () {
    ...
    UsageCWSResponse.deserialize = function (data) {
        var res = new UsageCWSResponse();
        res.usage = ObjectSerializer_1.ObjectSerializer.deserialize(data.usage, "Array<UsageCWSHour>", "");
        return res;
    };
    UsageCWSResponse.serialize = function (data) {
        var attributeTypes = UsageCWSResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.usage = ObjectSerializer_1.ObjectSerializer.serialize(data.usage, "Array<UsageCWSHour>", "");
        return res;
    };
    UsageCWSResponse.discriminator = undefined;
