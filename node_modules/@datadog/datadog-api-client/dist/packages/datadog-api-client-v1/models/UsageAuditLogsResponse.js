...
var UsageAuditLogsResponse = /** @class */ (function () {
    ...
    UsageAuditLogsResponse.deserialize = function (data) {
        var res = new UsageAuditLogsResponse();
        res.usage = ObjectSerializer_1.ObjectSerializer.deserialize(data.usage, "Array<UsageAuditLogsHour>", "");
        return res;
    };
    UsageAuditLogsResponse.serialize = function (data) {
        var attributeTypes = UsageAuditLogsResponse.getAttributeTypeMap();
        var res = {};
        ...
        res.usage = ObjectSerializer_1.ObjectSerializer.serialize(data.usage, "Array<UsageAuditLogsHour>", "");
        return res;
    };
    UsageAuditLogsResponse.discriminator = undefined;
