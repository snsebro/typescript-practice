...
export declare class PromiseAWSIntegrationApi {
    private api;
     ...
     */
    createAWSAccount(body: AWSAccount, options?: Configuration): Promise<AWSAccountCreateResponse>;
    /**
     ...
     */
    createAWSTagFilter(body: AWSTagFilterCreateRequest, options?: Configuration): Promise<any>;
    /**
     ...
     */
    createNewAWSExternalID(body: AWSAccount, options?: Configuration): Promise<AWSAccountCreateResponse>;
    /**
     * Delete a Datadog-AWS integration matching the specified `account_id` and `role_name parameters`.
     * Delete an AWS integration
     * @param body AWS request object
     */
    deleteAWSAccount(body: AWSAccount, options?: Configuration): Promise<any>;
    /**
     * Delete a tag filtering entry.
     * Delete a tag filtering entry
     * @param body Delete a tag filtering entry for a given AWS account and &#x60;dd-aws&#x60; namespace.
     */
    deleteAWSTagFilter(body: AWSTagFilterDeleteRequest, options?: Configuration): Promise<any>;
    /**
     ...
     */
    listAWSAccounts(accountId?: string, roleName?: string, accessKeyId?: string, options?: Configuration): Promise<AWSAccountListResponse>;
    /**
     * Get all AWS tag filters.
     * Get all AWS tag filters
     * @param accountId Only return AWS filters that matches this &#x60;account_id&#x60;.
     */
    listAWSTagFilters(accountId: string, options?: Configuration): Promise<AWSTagFilterListResponse>;
    /**
     ...
     */
    updateAWSAccount(body: AWSAccount, accountId?: string, roleName?: string, accessKeyId?: string, options?: Configuration): Promise<any>;
}
import { AWSLogsIntegrationApiRequestFactory, AWSLogsIntegrationApiResponseProcessor } from "../apis/AWSLogsIntegrationApi";
export declare class PromiseAWSLogsIntegrationApi {
    private api;
     ...
     */
    checkAWSLogsLambdaAsync(body: AWSAccountAndLambdaRequest, options?: Configuration): Promise<AWSLogsAsyncResponse>;
    /**
     ...
     */
    checkAWSLogsServicesAsync(body: AWSLogsServicesRequest, options?: Configuration): Promise<AWSLogsAsyncResponse>;
    /**
     * Attach the Lambda ARN of the Lambda created for the Datadog-AWS log collection to your AWS account ID to enable log collection.
     * Add AWS Log Lambda ARN
     * @param body AWS Log Lambda Async request body.
     */
    createAWSLambdaARN(body: AWSAccountAndLambdaRequest, options?: Configuration): Promise<any>;
    /**
     * Delete a Datadog-AWS logs configuration by removing the specific Lambda ARN associated with a given AWS account.
     * Delete an AWS Logs integration
     * @param body Delete AWS Lambda ARN request body.
     */
    deleteAWSLambdaARN(body: AWSAccountAndLambdaRequest, options?: Configuration): Promise<any>;
    /**
     * Enable automatic log collection for a list of services. This should be run after running `CreateAWSLambdaARN` to save the configuration.
     * Enable an AWS Logs integration
     * @param body Enable AWS Log Services request body.
     */
    enableAWSLogServices(body: AWSLogsServicesRequest, options?: Configuration): Promise<any>;
    /**
...
export declare class PromiseAzureIntegrationApi {
    private api;
     ...
     */
    createAzureIntegration(body: AzureAccount, options?: Configuration): Promise<any>;
    /**
     * Delete a given Datadog-Azure integration from your Datadog account.
     * Delete an Azure integration
     * @param body Delete a given Datadog-Azure integration request body.
     */
    deleteAzureIntegration(body: AzureAccount, options?: Configuration): Promise<any>;
    /**
     ...
     */
    updateAzureHostFilters(body: AzureAccount, options?: Configuration): Promise<any>;
    /**
     ...
     */
    updateAzureIntegration(body: AzureAccount, options?: Configuration): Promise<any>;
}
import { DashboardListsApiRequestFactory, DashboardListsApiResponseProcessor } from "../apis/DashboardListsApi";
export declare class PromiseDashboardListsApi {
    private api;
     ...
     */
    createDashboardList(body: DashboardList, options?: Configuration): Promise<DashboardList>;
    /**
     * Delete a dashboard list.
     * Delete a dashboard list
     * @param listId ID of the dashboard list to delete.
     */
    deleteDashboardList(listId: number, options?: Configuration): Promise<DashboardListDeleteResponse>;
    /**
     * Fetch an existing dashboard list's definition.
     * Get a dashboard list
     * @param listId ID of the dashboard list to fetch.
     */
    getDashboardList(listId: number, options?: Configuration): Promise<DashboardList>;
    /**
     ...
     */
    updateDashboardList(listId: number, body: DashboardList, options?: Configuration): Promise<DashboardList>;
}
import { DashboardsApiRequestFactory, DashboardsApiResponseProcessor } from "../apis/DashboardsApi";
export declare class PromiseDashboardsApi {
    private api;
     ...
     */
    createDashboard(body: Dashboard, options?: Configuration): Promise<Dashboard>;
    /**
     * Delete a dashboard using the specified ID.
     * Delete a dashboard
     * @param dashboardId The ID of the dashboard.
     */
    deleteDashboard(dashboardId: string, options?: Configuration): Promise<DashboardDeleteResponse>;
    /**
     * Get a dashboard using the specified ID.
     * Get a dashboard
     * @param dashboardId The ID of the dashboard.
     */
    getDashboard(dashboardId: string, options?: Configuration): Promise<Dashboard>;
    /**
     ...
     */
    listDashboards(filterShared?: boolean, options?: Configuration): Promise<DashboardSummary>;
    /**
     ...
     */
    updateDashboard(dashboardId: string, body: Dashboard, options?: Configuration): Promise<Dashboard>;
}
import { DowntimesApiRequestFactory, DowntimesApiResponseProcessor } from "../apis/DowntimesApi";
export declare class PromiseDowntimesApi {
    private api;
     ...
     */
    cancelDowntime(downtimeId: number, options?: Configuration): Promise<void>;
    /**
     * Delete all downtimes that match the scope of `X`.
     * Cancel downtimes by scope
     * @param body Scope to cancel downtimes for.
     */
    cancelDowntimesByScope(body: CancelDowntimesByScopeRequest, options?: Configuration): Promise<CanceledDowntimesIds>;
    /**
     * Schedule a downtime.
     * Schedule a downtime
     * @param body Schedule a downtime request body.
     */
    createDowntime(body: Downtime, options?: Configuration): Promise<Downtime>;
    /**
     * Get downtime detail by `downtime_id`.
     * Get a downtime
     * @param downtimeId ID of the downtime to fetch.
     */
    getDowntime(downtimeId: number, options?: Configuration): Promise<Downtime>;
    /**
     * Get all scheduled downtimes.
     * Get all downtimes
     * @param currentOnly Only return downtimes that are active when the request is made.
     */
    listDowntimes(currentOnly?: boolean, options?: Configuration): Promise<Array<Downtime>>;
    /**
     * Get all downtimes for the specified monitor
     * Get all downtimes for a monitor
     * @param monitorId The id of the monitor
     */
    listMonitorDowntimes(monitorId: number, options?: Configuration): Promise<Array<Downtime>>;
    /**
     ...
     */
    updateDowntime(downtimeId: number, body: Downtime, options?: Configuration): Promise<Downtime>;
}
...
export declare class PromiseEventsApi {
     ...
     */
    createEvent(body: EventCreateRequest, options?: Configuration): Promise<EventCreateResponse>;
    /**
     ...
     */
    getEvent(eventId: number, options?: Configuration): Promise<EventResponse>;
    /**
     ...
     */
    listEvents(start: number, end: number, priority?: EventPriority, sources?: string, tags?: string, unaggregated?: boolean, excludeAggregate?: boolean, page?: number, options?: Configuration): Promise<EventListResponse>;
}
import { GCPIntegrationApiRequestFactory, GCPIntegrationApiResponseProcessor } from "../apis/GCPIntegrationApi";
export declare class PromiseGCPIntegrationApi {
    private api;
     ...
     */
    createGCPIntegration(body: GCPAccount, options?: Configuration): Promise<any>;
    /**
     * Delete a given Datadog-GCP integration.
     * Delete a GCP integration
     * @param body Delete a given Datadog-GCP integration.
     */
    deleteGCPIntegration(body: GCPAccount, options?: Configuration): Promise<any>;
    /**
     ...
     */
    updateGCPIntegration(body: GCPAccount, options?: Configuration): Promise<any>;
}
import { HostsApiRequestFactory, HostsApiResponseProcessor } from "../apis/HostsApi";
export declare class PromiseHostsApi {
    private api;
     ...
     */
    getHostTotals(from?: number, options?: Configuration): Promise<HostTotals>;
    /**
     ...
     */
    listHosts(filter?: string, sortField?: string, sortDir?: string, start?: number, count?: number, from?: number, includeMutedHostsData?: boolean, includeHostsMetadata?: boolean, options?: Configuration): Promise<HostListResponse>;
    /**
     * Mute a host.
     * Mute a host
     ...
     */
    muteHost(hostName: string, body: HostMuteSettings, options?: Configuration): Promise<HostMuteResponse>;
    /**
     * Unmutes a host. This endpoint takes no JSON arguments.
     * Unmute a host
     * @param hostName Name of the host to unmute.
     */
    unmuteHost(hostName: string, options?: Configuration): Promise<HostMuteResponse>;
}
import { IPRangesApiRequestFactory, IPRangesApiResponseProcessor } from "../apis/IPRangesApi";
export declare class PromiseIPRangesApi {
    private api;
...
export declare class PromiseKeyManagementApi {
    private api;
     ...
     * @param body
     */
    createAPIKey(body: ApiKey, options?: Configuration): Promise<ApiKeyResponse>;
    /**
     * Create an application key with a given name.
     * Create an application key
     * @param body
     */
    createApplicationKey(body: ApplicationKey, options?: Configuration): Promise<ApplicationKeyResponse>;
    /**
     * Delete a given API key.
     * Delete an API key
     * @param key The specific API key you are working with.
     */
    deleteAPIKey(key: string, options?: Configuration): Promise<ApiKeyResponse>;
    /**
     * Delete a given application key.
     * Delete an application key
     * @param key The specific APP key you are working with.
     */
    deleteApplicationKey(key: string, options?: Configuration): Promise<ApplicationKeyResponse>;
    /**
     * Get a given API key.
     * Get API key
     * @param key The specific API key you are working with.
     */
    getAPIKey(key: string, options?: Configuration): Promise<ApiKeyResponse>;
    /**
     * Get a given application key.
     * Get an application key
     * @param key The specific APP key you are working with.
     */
    getApplicationKey(key: string, options?: Configuration): Promise<ApplicationKeyResponse>;
    /**
     ...
     * @param body
     */
    updateAPIKey(key: string, body: ApiKey, options?: Configuration): Promise<ApiKeyResponse>;
    /**
     ...
     * @param body
     */
    updateApplicationKey(key: string, body: ApplicationKey, options?: Configuration): Promise<ApplicationKeyResponse>;
}
...
export declare class PromiseLogsApi {
     ...
     */
    listLogs(body: LogsListRequest, options?: Configuration): Promise<LogsListResponse>;
    /**
     ...
     */
    submitLog(body: Array<HTTPLogItem>, contentEncoding?: ContentEncoding, ddtags?: string, options?: Configuration): Promise<any>;
}
import { LogsIndexesApiRequestFactory, LogsIndexesApiResponseProcessor } from "../apis/LogsIndexesApi";
export declare class PromiseLogsIndexesApi {
    private api;
     ...
     */
    createLogsIndex(body: LogsIndex, options?: Configuration): Promise<LogsIndex>;
    /**
     * Get one log index from your organization. This endpoint takes no JSON arguments.
     * Get an index
     * @param name Name of the log index.
     */
    getLogsIndex(name: string, options?: Configuration): Promise<LogsIndex>;
    /**
     ...
     */
    updateLogsIndex(name: string, body: LogsIndexUpdateRequest, options?: Configuration): Promise<LogsIndex>;
    /**
     * This endpoint updates the index order of your organization. It returns the index order object passed in the request body when the request is successful.
     * Update indexes order
     * @param body Object containing the new ordered list of index names
     */
    updateLogsIndexOrder(body: LogsIndexesOrder, options?: Configuration): Promise<LogsIndexesOrder>;
}
import { LogsPipelinesApiRequestFactory, LogsPipelinesApiResponseProcessor } from "../apis/LogsPipelinesApi";
export declare class PromiseLogsPipelinesApi {
    private api;
     ...
     */
    createLogsPipeline(body: LogsPipeline, options?: Configuration): Promise<LogsPipeline>;
    /**
     * Delete a given pipeline from your organization. This endpoint takes no JSON arguments.
     * Delete a pipeline
     * @param pipelineId ID of the pipeline to delete.
     */
    deleteLogsPipeline(pipelineId: string, options?: Configuration): Promise<void>;
    /**
     * Get a specific pipeline from your organization. This endpoint takes no JSON arguments.
     * Get a pipeline
     * @param pipelineId ID of the pipeline to get.
     */
    getLogsPipeline(pipelineId: string, options?: Configuration): Promise<LogsPipeline>;
    /**
     ...
     */
    updateLogsPipeline(pipelineId: string, body: LogsPipeline, options?: Configuration): Promise<LogsPipeline>;
    /**
     ...
     */
    updateLogsPipelineOrder(body: LogsPipelinesOrder, options?: Configuration): Promise<LogsPipelinesOrder>;
}
...
export declare class PromiseMetricsApi {
     ...
     */
    getMetricMetadata(metricName: string, options?: Configuration): Promise<MetricMetadata>;
    /**
     ...
     */
    listActiveMetrics(from: number, host?: string, tagFilter?: string, options?: Configuration): Promise<MetricsListResponse>;
    /**
     * Search for metrics from the last 24 hours in Datadog.
     * Search metrics
     * @param q Query string to search metrics upon. Must be prefixed with &#x60;metrics:&#x60;.
     */
    listMetrics(q: string, options?: Configuration): Promise<MetricSearchResponse>;
    /**
     ...
     */
    queryMetrics(from: number, to: number, query: string, options?: Configuration): Promise<MetricsQueryResponse>;
    /**
     ...
     * @param body
     */
    submitMetrics(body: MetricsPayload, options?: Configuration): Promise<IntakePayloadAccepted>;
    /**
     ...
     */
    updateMetricMetadata(metricName: string, body: MetricMetadata, options?: Configuration): Promise<MetricMetadata>;
}
import { MonitorsApiRequestFactory, MonitorsApiResponseProcessor } from "../apis/MonitorsApi";
export declare class PromiseMonitorsApi {
    private api;
     ...
     */
    checkCanDeleteMonitor(monitorIds: Array<number>, options?: Configuration): Promise<CheckCanDeleteMonitorResponse>;
    /**
     ...
     */
    createMonitor(body: Monitor, options?: Configuration): Promise<Monitor>;
    /**
     ...
     */
    deleteMonitor(monitorId: number, force?: string, options?: Configuration): Promise<DeletedMonitor>;
    /**
     ...
     */
    getMonitor(monitorId: number, groupStates?: string, options?: Configuration): Promise<Monitor>;
    /**
     * Get details about the specified monitor from your organization.
     ...
     */
    listMonitors(groupStates?: string, name?: string, tags?: string, monitorTags?: string, withDowntimes?: boolean, idOffset?: number, page?: number, pageSize?: number, options?: Configuration): Promise<Array<Monitor>>;
    /**
     ...
     */
    searchMonitorGroups(query?: string, page?: number, perPage?: number, sort?: string, options?: Configuration): Promise<MonitorGroupSearchResponse>;
    /**
     ...
     * @param sort String for sort order, composed of field and sort order separate by a comma, e.g. &#x60;name,asc&#x60;. Supported sort directions: &#x60;asc&#x60;, &#x60;desc&#x60;. Supported fields:  * &#x60;name&#x60; * &#x60;status&#x60; * &#x60;tags&#x60;
     */
    searchMonitors(query?: string, page?: number, perPage?: number, sort?: string, options?: Configuration): Promise<MonitorSearchResponse>;
    /**
     ...
     */
    updateMonitor(monitorId: number, body: MonitorUpdateRequest, options?: Configuration): Promise<Monitor>;
    /**
     * Validate the monitor provided in the request.
     * Validate a monitor
     * @param body Monitor request object
     */
    validateMonitor(body: Monitor, options?: Configuration): Promise<any>;
}
import { NotebooksApiRequestFactory, NotebooksApiResponseProcessor } from "../apis/NotebooksApi";
export declare class PromiseNotebooksApi {
    private api;
     ...
     */
    createNotebook(body: NotebookCreateRequest, options?: Configuration): Promise<NotebookResponse>;
    /**
     * Delete a notebook using the specified ID.
     * Delete a notebook
     * @param notebookId Unique ID, assigned when you create the notebook.
     */
    deleteNotebook(notebookId: number, options?: Configuration): Promise<void>;
    /**
     * Get a notebook using the specified notebook ID.
     * Get a notebook
     * @param notebookId Unique ID, assigned when you create the notebook.
     */
    getNotebook(notebookId: number, options?: Configuration): Promise<NotebookResponse>;
    /**
     ...
     */
    listNotebooks(authorHandle?: string, excludeAuthorHandle?: string, start?: number, count?: number, sortField?: string, sortDir?: string, query?: string, includeCells?: boolean, options?: Configuration): Promise<NotebooksResponse>;
    /**
     ...
     */
    updateNotebook(notebookId: number, body: NotebookUpdateRequest, options?: Configuration): Promise<NotebookResponse>;
}
import { OrganizationsApiRequestFactory, OrganizationsApiResponseProcessor } from "../apis/OrganizationsApi";
export declare class PromiseOrganizationsApi {
    private api;
     ...
     */
    createChildOrg(body: OrganizationCreateBody, options?: Configuration): Promise<OrganizationCreateResponse>;
    /**
     * Get organization information.
     * Get organization information
     * @param publicId The &#x60;public_id&#x60; of the organization you are operating within.
     */
    getOrg(publicId: string, options?: Configuration): Promise<OrganizationResponse>;
    /**
     ...
     * @param body
     */
    updateOrg(publicId: string, body: Organization, options?: Configuration): Promise<OrganizationResponse>;
    /**
     ...
     */
    uploadIdPForOrg(publicId: string, idpFile: HttpFile, options?: Configuration): Promise<IdpResponse>;
}
import { PagerDutyIntegrationApiRequestFactory, PagerDutyIntegrationApiResponseProcessor } from "../apis/PagerDutyIntegrationApi";
export declare class PromisePagerDutyIntegrationApi {
    private api;
     ...
     */
    createPagerDutyIntegrationService(body: PagerDutyService, options?: Configuration): Promise<PagerDutyServiceName>;
    /**
     * Delete a single service object in the Datadog-PagerDuty integration.
     * Delete a single service object
     * @param serviceName The service name
     */
    deletePagerDutyIntegrationService(serviceName: string, options?: Configuration): Promise<void>;
    /**
     * Get service name in the Datadog-PagerDuty integration.
     * Get a single service object
     * @param serviceName The service name.
     */
    getPagerDutyIntegrationService(serviceName: string, options?: Configuration): Promise<PagerDutyServiceName>;
    /**
     ...
     */
    updatePagerDutyIntegrationService(serviceName: string, body: PagerDutyServiceKey, options?: Configuration): Promise<void>;
}
import { ServiceChecksApiRequestFactory, ServiceChecksApiResponseProcessor } from "../apis/ServiceChecksApi";
export declare class PromiseServiceChecksApi {
    private api;
     ...
     */
    submitServiceCheck(body: Array<ServiceCheck>, options?: Configuration): Promise<IntakePayloadAccepted>;
}
...
export declare class PromiseServiceLevelObjectiveCorrectionsApi {
    private api;
     ...
     */
    createSLOCorrection(body: SLOCorrectionCreateRequest, options?: Configuration): Promise<SLOCorrectionResponse>;
    /**
     * Permanently delete the specified SLO correction object
     * Delete an SLO correction
     * @param sloCorrectionId The ID of the SLO correction object
     */
    deleteSLOCorrection(sloCorrectionId: string, options?: Configuration): Promise<void>;
    /**
     * Get an SLO correction
     * Get an SLO correction for an SLO
     * @param sloCorrectionId The ID of the SLO correction object
     */
    getSLOCorrection(sloCorrectionId: string, options?: Configuration): Promise<SLOCorrectionResponse>;
    /**
     * Get all Service Level Objective corrections
     * Get all SLO corrections
     */
    listSLOCorrection(options?: Configuration): Promise<SLOCorrectionListResponse>;
    /**
     ...
     */
    updateSLOCorrection(sloCorrectionId: string, body: SLOCorrectionUpdateRequest, options?: Configuration): Promise<SLOCorrectionResponse>;
}
...
export declare class PromiseServiceLevelObjectivesApi {
    private api;
     ...
     */
    checkCanDeleteSLO(ids: string, options?: Configuration): Promise<CheckCanDeleteSLOResponse>;
    /**
     * Create a service level objective object.
     * Create an SLO object
     * @param body Service level objective request object.
     */
    createSLO(body: ServiceLevelObjectiveRequest, options?: Configuration): Promise<SLOListResponse>;
    /**
     ...
     * @param force Delete the monitor even if it&#39;s referenced by other resources (e.g. SLO, composite monitor).
     */
    deleteSLO(sloId: string, force?: string, options?: Configuration): Promise<SLODeleteResponse>;
    /**
    ...
    }, options?: Configuration): Promise<SLOBulkDeleteResponse>;
    /**
     ...
     */
    getSLO(sloId: string, withConfiguredAlertIds?: boolean, options?: Configuration): Promise<SLOResponse>;
    /**
     ...
     */
    getSLOHistory(sloId: string, fromTs: number, toTs: number, target?: number, options?: Configuration): Promise<SLOHistoryResponse>;
    /**
     ...
     */
    listSLOs(ids?: string, query?: string, tagsQuery?: string, metricsQuery?: string, options?: Configuration): Promise<SLOListResponse>;
    /**
     ...
     */
    updateSLO(sloId: string, body: ServiceLevelObjective, options?: Configuration): Promise<SLOListResponse>;
}
import { SlackIntegrationApiRequestFactory, SlackIntegrationApiResponseProcessor } from "../apis/SlackIntegrationApi";
export declare class PromiseSlackIntegrationApi {
    private api;
     ...
     */
    createSlackIntegrationChannel(accountName: string, body: SlackIntegrationChannel, options?: Configuration): Promise<SlackIntegrationChannel>;
    /**
     ...
     */
    getSlackIntegrationChannel(accountName: string, channelName: string, options?: Configuration): Promise<SlackIntegrationChannel>;
    /**
     * Get a list of all channels configured for your Datadog-Slack integration.
     * Get all channels in a Slack integration
     * @param accountName Your Slack account name.
     */
    getSlackIntegrationChannels(accountName: string, options?: Configuration): Promise<Array<SlackIntegrationChannel>>;
    /**
     ...
     * @param channelName The name of the Slack channel being operated on.
     */
    removeSlackIntegrationChannel(accountName: string, channelName: string, options?: Configuration): Promise<void>;
    /**
     ...
     */
    updateSlackIntegrationChannel(accountName: string, channelName: string, body: SlackIntegrationChannel, options?: Configuration): Promise<SlackIntegrationChannel>;
}
import { SnapshotsApiRequestFactory, SnapshotsApiResponseProcessor } from "../apis/SnapshotsApi";
export declare class PromiseSnapshotsApi {
    private api;
     ...
     */
    getGraphSnapshot(start: number, end: number, metricQuery?: string, eventQuery?: string, graphDef?: string, title?: string, options?: Configuration): Promise<GraphSnapshot>;
}
import { SyntheticsApiRequestFactory, SyntheticsApiResponseProcessor } from "../apis/SyntheticsApi";
export declare class PromiseSyntheticsApi {
    private api;
     ...
     */
    createGlobalVariable(body: SyntheticsGlobalVariable, options?: Configuration): Promise<SyntheticsGlobalVariable>;
    /**
     * Create a new Synthetics private location.
     * Create a private location
     * @param body Details of the private location to create.
     */
    createPrivateLocation(body: SyntheticsPrivateLocation, options?: Configuration): Promise<SyntheticsPrivateLocationCreationResponse>;
    /**
     * Create a Synthetic API test.
     * Create an API test
     * @param body Details of the test to create.
     */
    createSyntheticsAPITest(body: SyntheticsAPITest, options?: Configuration): Promise<SyntheticsAPITest>;
    /**
     * Create a Synthetic browser test.
     * Create a browser test
     * @param body Details of the test to create.
     */
    createSyntheticsBrowserTest(body: SyntheticsBrowserTest, options?: Configuration): Promise<SyntheticsBrowserTest>;
    /**
     * Delete a Synthetics global variable.
     * Delete a global variable
     * @param variableId The ID of the global variable.
     */
    deleteGlobalVariable(variableId: string, options?: Configuration): Promise<void>;
    /**
     * Delete a Synthetics private location.
     * Delete a private location
     * @param locationId The ID of the private location.
     */
    deletePrivateLocation(locationId: string, options?: Configuration): Promise<void>;
    /**
     * Delete multiple Synthetic tests by ID.
     * Delete tests
     * @param body Public ID list of the Synthetic tests to be deleted.
     */
    deleteTests(body: SyntheticsDeleteTestsPayload, options?: Configuration): Promise<SyntheticsDeleteTestsResponse>;
    /**
     ...
     */
    editGlobalVariable(variableId: string, body: SyntheticsGlobalVariable, options?: Configuration): Promise<SyntheticsGlobalVariable>;
    /**
     ...
     */
    getAPITest(publicId: string, options?: Configuration): Promise<SyntheticsAPITest>;
    /**
     ...
     */
    getAPITestLatestResults(publicId: string, fromTs?: number, toTs?: number, probeDc?: Array<string>, options?: Configuration): Promise<SyntheticsGetAPITestLatestResultsResponse>;
    /**
     ...
     */
    getAPITestResult(publicId: string, resultId: string, options?: Configuration): Promise<SyntheticsAPITestResultFull>;
    /**
     * Get the detailed configuration (including steps) associated with a Synthetic browser test.
     * Get a browser test
     * @param publicId The public ID of the test to get details from.
     */
    getBrowserTest(publicId: string, options?: Configuration): Promise<SyntheticsBrowserTest>;
    /**
     ...
     * @param probeDc Locations for which to query results.
     */
    getBrowserTestLatestResults(publicId: string, fromTs?: number, toTs?: number, probeDc?: Array<string>, options?: Configuration): Promise<SyntheticsGetBrowserTestLatestResultsResponse>;
    /**
     ...
     * @param resultId The ID of the result to get.
     */
    getBrowserTestResult(publicId: string, resultId: string, options?: Configuration): Promise<SyntheticsBrowserTestResultFull>;
    /**
     * Get the detailed configuration of a global variable.
     * Get a global variable
     * @param variableId The ID of the global variable.
     */
    getGlobalVariable(variableId: string, options?: Configuration): Promise<SyntheticsGlobalVariable>;
    /**
     * Get a Synthetics private location.
     * Get a private location
     * @param locationId The ID of the private location.
     */
    getPrivateLocation(locationId: string, options?: Configuration): Promise<SyntheticsPrivateLocation>;
    /**
     * Get the detailed configuration associated with a Synthetics test.
     * Get a test configuration
     * @param publicId The public ID of the test to get details from.
     */
    getTest(publicId: string, options?: Configuration): Promise<SyntheticsTestDetails>;
    /**
     ...
     */
    listTests(options?: Configuration): Promise<SyntheticsListTestsResponse>;
    /**
     * Trigger a set of Synthetics tests for continuous integration.
     * Trigger tests from CI/CD pipelines
     * @param body Details of the test to trigger.
     */
    triggerCITests(body: SyntheticsCITestBody, options?: Configuration): Promise<SyntheticsTriggerCITestsResponse>;
    /**
     ...
     */
    updateAPITest(publicId: string, body: SyntheticsAPITest, options?: Configuration): Promise<SyntheticsAPITest>;
    /**
     ...
     * @param body New test details to be saved.
     */
    updateBrowserTest(publicId: string, body: SyntheticsBrowserTest, options?: Configuration): Promise<SyntheticsBrowserTest>;
    /**
     ...
     */
    updatePrivateLocation(locationId: string, body: SyntheticsPrivateLocation, options?: Configuration): Promise<SyntheticsPrivateLocation>;
    /**
     ...
     */
    updateTestPauseStatus(publicId: string, body: SyntheticsUpdateTestPauseStatusPayload, options?: Configuration): Promise<boolean>;
}
...
export declare class PromiseTagsApi {
     ...
     */
    createHostTags(hostName: string, body: HostTags, source?: string, options?: Configuration): Promise<HostTags>;
    /**
     ...
     */
    deleteHostTags(hostName: string, source?: string, options?: Configuration): Promise<void>;
    /**
     ...
     */
    getHostTags(hostName: string, source?: string, options?: Configuration): Promise<HostTags>;
    /**
     * Return a mapping of tags to hosts for your whole infrastructure.
     * Get Tags
     * @param source When specified, filters host list to those tags with the specified source.
     */
    listHostTags(source?: string, options?: Configuration): Promise<TagToHosts>;
    /**
     ...
     * @param source The source of the tags (e.g. chef, puppet). [Complete list of source attribute values](https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value)
     */
    updateHostTags(hostName: string, body: HostTags, source?: string, options?: Configuration): Promise<HostTags>;
}
import { UsageMeteringApiRequestFactory, UsageMeteringApiResponseProcessor } from "../apis/UsageMeteringApi";
export declare class PromiseUsageMeteringApi {
    private api;
     ...
     */
    getDailyCustomReports(pageSize?: number, pageNumber?: number, sortDir?: UsageSortDirection, sort?: UsageSort, options?: Configuration): Promise<UsageCustomReportsResponse>;
    /**
     ...
     */
    getIncidentManagement(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageIncidentManagementResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getIngestedSpans(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageIngestedSpansResponse>;
    /**
     ...
     * @param sort The field to sort by: &#x60;[computed_on, size, start_date, end_date]&#x60;.
     */
    getMonthlyCustomReports(pageSize?: number, pageNumber?: number, sortDir?: UsageSortDirection, sort?: UsageSort, options?: Configuration): Promise<UsageCustomReportsResponse>;
    /**
     * Get specified daily custom reports.
     * Get specified daily custom reports
     * @param reportId The specified ID to search results for.
     */
    getSpecifiedDailyCustomReports(reportId: string, options?: Configuration): Promise<UsageSpecifiedCustomReportsResponse>;
    /**
     * Get specified monthly custom reports.
     * Get specified monthly custom reports
     * @param reportId The specified ID to search results for.
     */
    getSpecifiedMonthlyCustomReports(reportId: string, options?: Configuration): Promise<UsageSpecifiedCustomReportsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getTracingWithoutLimits(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageTracingWithoutLimitsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageAnalyzedLogs(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageAnalyzedLogsResponse>;
    /**
     ...
     */
    getUsageAttribution(startMonth: Date, fields: UsageAttributionSupportedMetrics, endMonth?: Date, sortDirection?: UsageSortDirection, sortName?: UsageAttributionSort, options?: Configuration): Promise<UsageAttributionResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageAuditLogs(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageAuditLogsResponse>;
    /**
     * Get billable usage across your account.
     * Get billable usage across your account
     * @param month Datetime in ISO-8601 format, UTC, precise to month: &#x60;[YYYY-MM]&#x60; for usage starting this month.
     */
    getUsageBillableSummary(month?: Date, options?: Configuration): Promise<UsageBillableSummaryResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageCWS(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageCWSResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageCloudSecurityPostureManagement(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageCloudSecurityPostureManagementResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageFargate(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageFargateResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageHosts(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageHostsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageIndexedSpans(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageIndexedSpansResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageInternetOfThings(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageIoTResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageLambda(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageLambdaResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageLogs(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageLogsResponse>;
    /**
     ...
     */
    getUsageLogsByIndex(startHr: Date, endHr?: Date, indexName?: Array<string>, options?: Configuration): Promise<UsageLogsByIndexResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageLogsByRetention(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageLogsByRetentionResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageNetworkFlows(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageNetworkFlowsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageNetworkHosts(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageNetworkHostsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageProfiling(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageProfilingResponse>;
    /**
     ...
     */
    getUsageRumSessions(startHr: Date, endHr?: Date, type?: string, options?: Configuration): Promise<UsageRumSessionsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageSNMP(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageSNMPResponse>;
    /**
     ...
     */
    getUsageSummary(startMonth: Date, endMonth?: Date, includeOrgDetails?: boolean, options?: Configuration): Promise<UsageSummaryResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageSynthetics(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageSyntheticsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageSyntheticsAPI(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageSyntheticsAPIResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageSyntheticsBrowser(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageSyntheticsBrowserResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageTimeseries(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageTimeseriesResponse>;
    /**
     ...
     */
    getUsageTopAvgMetrics(month?: Date, day?: Date, names?: Array<string>, limit?: number, nextRecordId?: string, options?: Configuration): Promise<UsageTopAvgMetricsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: [YYYY-MM-DDThh] for usage ending **before** this hour.
     */
    getUsageTrace(startHr: Date, endHr?: Date, options?: Configuration): Promise<UsageTraceResponse>;
}
...
export declare class PromiseUsersApi {
     ...
     */
    createUser(body: User, options?: Configuration): Promise<UserResponse>;
    /**
     ...
     */
    disableUser(userHandle: string, options?: Configuration): Promise<UserDisableResponse>;
    /**
     * Get a user's details.
     * Get user details
     * @param userHandle The ID of the user.
     */
    getUser(userHandle: string, options?: Configuration): Promise<UserResponse>;
    /**
     ...
     */
    updateUser(userHandle: string, body: User, options?: Configuration): Promise<UserResponse>;
}
