...
export declare class ObservableMonitorsApi {
     ...
     */
    searchMonitorGroups(query?: string, page?: number, perPage?: number, sort?: string, options?: Configuration): Observable<MonitorGroupSearchResponse>;
    /**
     ...
     * @param sort String for sort order, composed of field and sort order separate by a comma, e.g. &#x60;name,asc&#x60;. Supported sort directions: &#x60;asc&#x60;, &#x60;desc&#x60;. Supported fields:  * &#x60;name&#x60; * &#x60;status&#x60; * &#x60;tags&#x60;
     */
    searchMonitors(query?: string, page?: number, perPage?: number, sort?: string, options?: Configuration): Observable<MonitorSearchResponse>;
    /**
...
export declare class ObservableSyntheticsApi {
     ...
     */
    listGlobalVariables(options?: Configuration): Observable<SyntheticsListGlobalVariablesResponse>;
    /**
...
export declare class ObservableUsageMeteringApi {
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageAuditLogs(startHr: Date, endHr?: Date, options?: Configuration): Observable<UsageAuditLogsResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageCWS(startHr: Date, endHr?: Date, options?: Configuration): Observable<UsageCWSResponse>;
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    getUsageCloudSecurityPostureManagement(startHr: Date, endHr?: Date, options?: Configuration): Observable<UsageCloudSecurityPostureManagementResponse>;
    /**
