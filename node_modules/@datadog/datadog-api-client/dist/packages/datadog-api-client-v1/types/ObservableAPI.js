...
var ObservableMonitorsApi = /** @class */ (function () {
     ...
     */
    ObservableMonitorsApi.prototype.searchMonitorGroups = function (query, page, perPage, sort, options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.searchMonitorGroups(query, page, perPage, sort, options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.searchMonitorGroups(rsp); }));
        }));
    };
    /**
     ...
     * @param sort String for sort order, composed of field and sort order separate by a comma, e.g. &#x60;name,asc&#x60;. Supported sort directions: &#x60;asc&#x60;, &#x60;desc&#x60;. Supported fields:  * &#x60;name&#x60; * &#x60;status&#x60; * &#x60;tags&#x60;
     */
    ObservableMonitorsApi.prototype.searchMonitors = function (query, page, perPage, sort, options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.searchMonitors(query, page, perPage, sort, options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.searchMonitors(rsp); }));
        }));
    };
    /**
...
var ObservableSyntheticsApi = /** @class */ (function () {
     ...
     */
    ObservableSyntheticsApi.prototype.listGlobalVariables = function (options) {
        var _this = this;
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.listGlobalVariables(rsp); }));
        }));
    };
    /**
...
var ObservableUsageMeteringApi = /** @class */ (function () {
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    ObservableUsageMeteringApi.prototype.getUsageAuditLogs = function (startHr, endHr, options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getUsageAuditLogs(startHr, endHr, options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.getUsageAuditLogs(rsp); }));
        }));
    };
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    ObservableUsageMeteringApi.prototype.getUsageCWS = function (startHr, endHr, options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getUsageCWS(startHr, endHr, options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.getUsageCWS(rsp); }));
        }));
    };
    /**
     ...
     * @param endHr Datetime in ISO-8601 format, UTC, precise to hour: &#x60;[YYYY-MM-DDThh]&#x60; for usage ending **before** this hour.
     */
    ObservableUsageMeteringApi.prototype.getUsageCloudSecurityPostureManagement = function (startHr, endHr, options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getUsageCloudSecurityPostureManagement(startHr, endHr, options);
        // build promise chain
        var middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map(function (rsp) { return _this.responseProcessor.getUsageCloudSecurityPostureManagement(rsp); }));
        }));
    };
    /**
